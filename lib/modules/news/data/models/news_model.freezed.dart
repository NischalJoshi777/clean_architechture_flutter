...
class _$_NewsModel implements _NewsModel {
  const _$_NewsModel(
      {this.status, this.totalResults = 0, this.articles = const []});
...
mixin _$ArticleModel {
  SourceModel? get sourceModel => throw _privateConstructorUsedError;
...
abstract class $ArticleModelCopyWith<$Res> {
  ...
  $SourceModelCopyWith<$Res>? get sourceModel;
}
...
class _$ArticleModelCopyWithImpl<$Res> implements $ArticleModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      sourceModel: sourceModel == freezed
          ? _value.sourceModel
          : sourceModel // ignore: cast_nullable_to_non_nullable
              as SourceModel?,
  ...
  @override
  $SourceModelCopyWith<$Res>? get sourceModel {
    if (_value.sourceModel == null) {
      return null;
    }

    return $SourceModelCopyWith<$Res>(_value.sourceModel!, (value) {
      return _then(_value.copyWith(sourceModel: value));
    });
  }
}
...
class _$_ArticleModel implements _ArticleModel {
  ...
  @override
  String toString() {
    return 'ArticleModel(sourceModel: $sourceModel, author: $author, title: $title, description: $description, url: $url, urlToImage: $urlToImage, publishedAt: $publishedAt, content: $content)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.sourceModel, sourceModel) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(sourceModel),
...
class _$SourceModelTearOff {
  ...
  _SourceModel call({required String id, required String name}) {
    return _SourceModel(
      id: id,
      name: name,
    );
...
class _$_SourceModel implements _SourceModel {
  const _$_SourceModel({required this.id, required this.name});
...
abstract class _SourceModel implements SourceModel {
  const factory _SourceModel({required String id, required String name}) =
      _$_SourceModel;
